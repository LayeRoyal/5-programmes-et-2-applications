...
<body>
  ...
  <div class="marquee-rtl">
    ...
    <form method="post" class="form">
     NBRE DE MOT: <input class="nbr" type="text" name="nbrmot" value="<?php if(isset($_POST['nbrmot'])){echo $_POST['nbrmot'];}elseif(isset($_POST['Aff'])){ echo count($_POST)-1;}?>" >
